...
public class Step2_CreateOutputFiles {
	...
	private static File scriptTempFile = null;//new File(IOUtil.dataPath + IOUtil.TMP +IOUtil.R_SCRIPTNAME);

	private static File p2_in_directory = null;//new File(IOUtil.dataPath + IOUtil.IN +IOUtil.P2_PATH);
	private static File p3_in_directory = null;//new File(IOUtil.dataPath + IOUtil.IN +IOUtil.P3_PATH);
	private static File t_in_directory = null;//new File(IOUtil.dataPath + IOUtil.IN +IOUtil.T_PATH);
	private static File m_in_directory = null;//new File(IOUtil.dataPath + IOUtil.IN +IOUtil.M_PATH);
	private static File g_in_directory = null;//new File(IOUtil.dataPath + IOUtil.IN +IOUtil.G_PATH);

	public static void main(String[] args) throws IOException,
			InterruptedException {

		File p2_out_directory = null;//new File(IOUtil.dataPath + IOUtil.OUT +IOUtil.P2_PATH);
		File p3_out_directory = null;//new File(IOUtil.dataPath + IOUtil.OUT +IOUtil.P3_PATH);
		File t_out_directory = null;//new File(IOUtil.dataPath + IOUtil.OUT +IOUtil.T_PATH);
		File m_out_directory = null;//new File(IOUtil.dataPath + IOUtil.OUT +IOUtil.M_PATH);
		File g_out_directory = null;//new File(IOUtil.dataPath + IOUtil.OUT +IOUtil.G_PATH);
	...
	private static void writeCompositionOutputFiles(
		...
		File p2_out_composition_directory = null;//new File(IOUtil.dataPath + IOUtil.OUT + IOUtil.COMPOSITION +IOUtil.P2_PATH);
		File p3_out_composition_directory = null;//new File(IOUtil.dataPath + IOUtil.OUT + IOUtil.COMPOSITION +IOUtil.P3_PATH);
		File m_in_composition_directory = null;//new File(IOUtil.dataPath + IOUtil.IN + IOUtil.COMPOSITION +IOUtil.M_PATH);
		File m_out_composition_directory = null;//new File(IOUtil.dataPath + IOUtil.OUT + IOUtil.COMPOSITION +IOUtil.M_PATH);
